                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tituloDriver" name="tituloDriver" value="<?php echo $query->nome; ?>">
                    ...
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="block-driver">
                                ...
                                <p id="driver-name"><?php echo $query->driver; ?></p>
                    ...
                    <div class="col-12">
                        ...
                        <input type="hidden" name="driverFile" id="driverName" value="<?php echo $query->driver; ?>">
