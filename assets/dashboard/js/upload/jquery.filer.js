...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            ...
            errors: {
                filesLimit: "O máximo de {{fi-limit}} imagens são permitidas!",
                filesType: "Apenas imagens JPG são permitidas!",
                filesSize: "A imagem {{fi-name}} é maior que o tamanho máximo de {{fi-fileMaxSize}} MB permitido!",
